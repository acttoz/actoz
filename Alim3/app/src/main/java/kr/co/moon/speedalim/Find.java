...
public class Find extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		finishToast = Toast.makeText(Find.this, "'뒤로'버튼을 한번 더 누르시면 종료됩니다.",
				Toast.LENGTH_SHORT);
				...
				if (json != null) {
					...
					for (int i = 0; i < jsonResult.length(); i++) {
						...
						if (!jsonobject.getString(TAG).equals("")) {
							data = new Custom_List_Data(jsonobject.getString(TAG));
							dateList.add(data);
						}

					}
					listAdapter = new Adapter_QuizView(Find.this,

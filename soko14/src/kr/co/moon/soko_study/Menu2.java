...
public class Menu2 extends Activity implements OnClickListener {
	...
	public void buttonDown(ImageView btn, boolean click) {
		alpha = btn.getBackground();
		if (click)
			alpha.setColorFilter(0x88FF0000, Mode.SRC_ATOP);
		else
			alpha.setColorFilter(0x88FFFFFF, Mode.SRC_ATOP);
	}

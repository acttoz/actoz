...
public class Quiz3 extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Quiz2 quizAct = (Quiz2) Quiz2.quiz1;
		quizAct.finish();
		FirstMenu.mp.setVolume(0.5f, 0.5f);
		LinearLayout background = (LinearLayout) findViewById(R.id.back);
		background.setBackgroundResource(R.drawable.quiz3);
		quiz1 = this;
	...
	public void onClick(View v) {
		...
		case R.id.imageButton4:
			...
			startActivity(new Intent(this, Right3.class));
			break;
		}
		switch (v.getId()) {

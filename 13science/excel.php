...
$user = "actoz"; // your db's privileged user account
$password = "0453acac"; // and it's password
$db_name = "actoz"; // db name
$tbl_name = "13science"; // table name of the selected db

$link = mysql_connect ($host, $user, $password) or die('Could not connect: ' . mysql_error());
mysql_select_db($db_name) or die('Could not select database');

$select = "SELECT ban,num,name,answer,a1,a2,a3,a4,a5,reason FROM 13science WHERE class ='" . $_REQUEST['mClass'] ."' and quiz='".$_REQUEST['quiz']. "' ORDER BY ban ASC, num ASC";

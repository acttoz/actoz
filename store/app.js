var app_names = ['<img class="store_icon" src="img/icon/android.png"/>손안에서 둘러보는 <br/> 우리나라 특산물', '<img class="store_icon" src="img/icon/android.png"/>스마트 사이언스', '<img class="store_icon" src="img/icon/android.png"/>전래동화와 함께<br/>떠나는 수학나라', '<img class="store_icon" src="img/icon/android.png"/>가야의 땅 경남', '<img class="store_icon" src="img/icon/android.png"/>지구와 달', '<img class="store_icon" src="img/icon/android.png"/>위인이 들려주는<br/> 역사 이야기', '<img class="store_icon" src="img/icon/android.png"/>역사 속 인물탐구', '<img class="store_icon" src="img/icon/android.png"/>스마트 실험실', '<img class="store_icon" src="img/icon/android.png"/>한국사 타임머신', '<img class="store_icon" src="img/icon/android.png"/>사회과부도', '<img class="store_icon" src="img/icon/android.png"/>학교생활<br/>퀵 가이드', '<img class="store_icon" src="img/icon/ios.png"/>무지개 학급경영', '<img class="store_icon" src="img/icon/pdf.png"/>모듬학습<br/>도구 Top 21', '<img class="store_icon" src="img/icon/pdf.png"/>내꺼야?<br/>네꺼야?','<img class="store_icon" src="img/icon/pdf.png"/>내 손안의<br/>스마트 2.0','<img class="store_icon" src="img/icon/android.png"/>좋은책'];

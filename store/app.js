var app_names = ['손안에서 둘러보는 <br/> 우리나라 특산물', '스마트 사이언스', '전래동화와 함께<br/>떠나는 수학나라', '가야의 땅 경남', '지구와 달', '위인이 들려주는<br/> 역사 이야기', '역사 속 인물탐구', '스마트 실험실', '한국사 타임머신', '사회과부도', '학교생활<br/>퀵 가이드', '무지개 학급경영', '모듬학습<br/>도구 Top 20', '내꺼야?<br/>네꺼야?'];

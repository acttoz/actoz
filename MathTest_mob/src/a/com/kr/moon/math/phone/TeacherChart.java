...
public class TeacherChart extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Toast toast = Toast.makeText(this, "견본:1학기", 5000);
	...
	public void showChart(int period) {// 표시할 수치값
		...
		DayHelper mHelper;
		SQLiteDatabase db;
		mHelper = new DayHelper(TeacherChart.this);
		...
		if (cursor.moveToFirst()) {
			...
			do {
				...
				if (cursor2.moveToFirst()) {
					...
					if (limit < cursor2.getInt(0) * 3)
						limit = cursor2.getInt(0) * 3;
